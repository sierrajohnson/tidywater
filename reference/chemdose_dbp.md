...
#> Warning: pH is outside the model bounds of pH = 7.5 for coagulated water (3 rows
#> affected.)
#> Warning: Temperature is outside the model bounds of temp=20 Celsius for coagulated
#> water. (2 rows affected.)
# }
```
